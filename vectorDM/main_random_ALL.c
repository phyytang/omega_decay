...
{  int err;
  ...
  for(Case_i=1;Case_i<5;Case_i++){
      switch(Case_i){
      case 1:
	MVx=400; MSx=500; break;
      case 2:
	MVx=400; MSx=250; break;
      case 3:
	MVx=120; MSx=200; break;
      case 4:
	MVx=120; MSx=100; break;
      }
      
      assignValW("MH2",MSx);         
      assignValW("MX",MVx);

    for(Loop_i=0;Loop_i<10001;Loop_i++){
